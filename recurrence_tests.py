...
class TestLO(TestCase):
    ...
    def test_fig6a(self):
        g = from_adjacency_list([
            ...
            [5, 6, 7, 8, 21, 22, 1, 2],
            [11, 12, 13, 14],
            [10, 12, 13, 14, 18, 19, 23, 24],
            [10, 11, 13, 14, 18, 19, 23, 24],
            [10, 11, 12, 14, 1, 2, 6, 7],
            [10, 11, 12, 13, 1, 2, 6, 7],
            [16, 17, 18, 19],
            [15, 17, 18, 19, 23, 24, 3, 4],
            [15, 16, 18, 19, 23, 24, 3, 4],
            [15, 16, 17, 19, 6, 7, 11, 12],
            [15, 16, 17, 18, 6, 7, 11, 12],
            [21, 22, 23, 24],
            [20, 22, 23, 24, 3, 4, 8, 9],
            [20, 21, 23, 24, 3, 4, 8, 9],
            [20, 21, 22, 24, 11, 12, 16, 17],
            [20, 21, 22, 23, 11, 12, 16, 17]
        ])
